    ...
    <!-- <div class="elrow"> -->
        ...
        <el-col :span="10"  >
            ...
            <el-menu
              ...
              @open="handleOpen"
              @close="handleClose"
              text-color="#FFFFFF" active-text-color="#024aff" background-color="#373737"
            >
            ...
            <el-sub-menu index="2">
                ...
                <el-menu-item index="/mine/manage">我的</el-menu-item>
                <el-menu-item index="/mine/upload">我的上传</el-menu-item>
                <el-menu-item index="2-3" @click="logout">退出登录</el-menu-item>
            </el-sub-menu>  
                <!-- <div v-for="(item,index) in asyncRoutes">
                <div v-if="item.meta.alwaysShow" class="elsubmenu">
        ...
        <el-col :span="10">
            <!-- 搜索框 -->
            <div class="search" v-show ="$route.path=='/home'||$route.path=='/game'||$route.path=='/mine/manage'">
                <el-input
                v-model="searchValue"
                placeholder="输入游戏名搜索"
...
<script lang="ts" setup>
    ...
    // (searchValue.value as any).validate(async(valid: boolean) => {
    //   if(valid){
        // loading.value = true;
        // try {
        //     router.push({
        //         path:'/search'
        //     })
        //   const result:any = await adminStore.login(loginForm.username,loginForm.password)
        //     if(adminStore.token){
        //       router.push({
        //       path:'/'
        //     })
...
<style scoped>
*{
        /* background-color: rgb(55, 55, 55);  #373737*/
        color: #ffffff;

    }
    .elmenu ::v-deep .el-menu{
        /* background: linear-gradient(to right, #ff0000, #0000ff); */
        background-color: #373737 !important;
        border-color: #373737 !important;
    }
    .elmenu ::v-deep .el-menu:hover {
        background-color: #373737  !important ;
    }
    .elmenuitem ::v-deep .el-menu-item:hover {
        color: #419bf5;
        background-color: #ffffff !important;
    }

    .elmenuitem ::v-deep .el-menu-item.is-active {
        color: #6681fa;
        background-color: #ffffff !important;
    }
