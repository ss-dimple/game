    ...
    <div class="searchBar">   
        <el-form :inline="true" :model="searchUserForm" class="demo-form-inline">
            <el-form-item label="用户状态">
                <el-select v-model="searchUserForm.status"  placeholder="选择用户状态" style="width: 100px;">
                    <el-option
                        key=1
                        label="可用"
                        :value=1
            ...
            <el-form-item label="登录名">
                <el-input v-model="searchUserForm.username" clearable placeholder="登录名" style="width: 100px;"/>
            </el-form-item>
            ...
            <el-form-item label="公司名称">
                <el-input v-model="searchUserForm.company" clearable placeholder="公司" style="width: 200px;"/>
            </el-form-item>
            <el-form-item>
