<template>
    <div class="searchBar">   
        <el-form :inline="true" :model="searchUserForm" class="demo-form-inline">
            <el-form-item label="标签名">
                <el-input v-model="searchUserForm.tagName" clearable placeholder="标签名" style="width: 100px;"/>
            </el-form-item>
            <el-form-item label="标签级别">
                <el-input v-model="searchUserForm.tagLevel" clearable placeholder="标签级别" style="width: 100px;"/>
            </el-form-item>
            <el-form-item>
    ...
    <div>
        <el-table :data="tableData" stripe style="width: 100%" >
            ...
            <el-table-column prop="tagLevel" label="标签级别" />
